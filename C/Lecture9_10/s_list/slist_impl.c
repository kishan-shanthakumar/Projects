...
void initialize_list(s_list* l, s_list* l2)
{
	l -> head = NULL;
	l2 -> head = NULL;
	l -> no_Of_Nodes = 0;
...
void ordered_List(s_list* l, int data)
{
	node_t* new = create_Node(data);
...
void concatenate_List(s_list* l, s_list* l2)
{
	node_t* temp = l -> head;
	node_t* temp2 = l2 -> head;
